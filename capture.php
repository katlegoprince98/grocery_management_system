...
<head>
    ...
    <body style="margin-top:-40px; background-color: #8aca38;">
        ...
        <form style="margin: 0;" action="control.php" method="post"  id="submission_form">
            ...
            <!-- Text input-->
            <div class="form-group">
            <label class="col-md-4 control-label">Enter Shop</label> 
                <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input name="shop" placeholder="Enter Shop" class="form-control"  type="text" required>
                </div>
            </div>
            </div>
            ...
            <!-- Text input-->
            <div class="form-group">
            <label class="col-md-4 control-label">Enter Item Price</label>  
                <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
